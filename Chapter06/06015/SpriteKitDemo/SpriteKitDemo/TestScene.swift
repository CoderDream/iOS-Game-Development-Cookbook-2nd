...
//        effect.addChild(imageSprite)
        ...
        let oval = UIBezierPath(ovalIn:CGRect(x: 0, y: 0,
                                              width: 100, height: 200))
        
        let customShape = UIBezierPath()
        customShape.move(to: CGPoint(x: 0, y: 0))
        customShape.addLine(to: CGPoint(x: 0, y: 100))
        customShape.addCurve(to: CGPoint(x: 0, y: 0),
                             controlPoint1:CGPoint(x: 100, y: 100),
                             controlPoint2:CGPoint(x: 100, y: 0))

        let shape1 = SKShapeNode(path: rectangle.cgPath)
        // 外框颜色
        ...
        // 晕开效果
        shape1.glowWidth = 4
        shape1.position = CGPoint(x: 50, y: 150)
        shape1.blendMode = SKBlendMode.add //  .multiplyX2  //.add
        
        let shape2 = SKShapeNode(path: roundedRect.cgPath)
        // 外框颜色
        shape2.strokeColor = SKColor.green
        // 填充颜色
        shape2.fillColor = SKColor.gray
        // 晕开效果
        shape2.glowWidth = 4
        shape2.position = CGPoint(x: 150, y: 200)
        shape2.blendMode = SKBlendMode.add //  .multiplyX2  //.add
        
        let shape3 = SKShapeNode(path: oval.cgPath)
        // 外框颜色
        shape3.strokeColor = SKColor.green
        // 填充颜色
        shape3.fillColor = SKColor.yellow
        // 晕开效果
        shape3.glowWidth = 4
        shape3.position = CGPoint(x: 200, y: 400)
        shape3.blendMode = SKBlendMode.add //  .multiplyX2  //.add
        
        let shape4 = SKShapeNode(path: customShape.cgPath)
        // 外框颜色
        shape4.strokeColor = SKColor.green
        // 填充颜色
        shape4.fillColor = SKColor.blue
        // 晕开效果
        shape4.glowWidth = 4
        shape4.position = CGPoint(x: 250, y: 600)
        shape4.blendMode = SKBlendMode.add //  .multiplyX2  //.add
        
        customShape.close()
        myScene.addChild(shape1)
        myScene.addChild(shape2)
        myScene.addChild(shape3)
        myScene.addChild(shape4)
        // END bezier_paths
    }
